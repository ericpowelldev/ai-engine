...
<!-- OPTIONAL. Module-specific orientation steps, followed by /orient once this module
     is resolved. The baseline (system mechanics, always-on rules) is already covered
     by the command; this file owns the rest. Delete this file to fall back to the
     generic behavior (read README, follow routing). -->
