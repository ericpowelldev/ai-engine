---
description: Orient (or re-orient) the session — always-on modules plus the relevant scoped module; optionally target a module by name (fuzzy, e.g. "hd" for HopDrive)
---
