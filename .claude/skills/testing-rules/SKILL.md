---
name: testing-rules
description: Load BEFORE planning, writing, or running tests of any kind. Loads the testing rules from every active module.
---
...
2. Read `rules/rules-testing.md` from each active module that has one.
